...
description: Use this agent when coordinating launches, managing release processes, or executing go-to-market strategies
tools: Read, Write, MultiEdit, Grep, Glob, TodoWrite, WebSearch, AskUserQuestion, Bash, TaskOutput, Edits, KillShell, Skill, Task, WebFetch
model: opus
