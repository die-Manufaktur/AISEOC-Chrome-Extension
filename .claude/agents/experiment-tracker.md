...
color: blue
tools: Read, Write, MultiEdit, Grep, Glob, TodoWrite, AskUserQuestion, Bash, TaskOutput, Edits, KillShell, Skill, Task, WebFetch, WebSearch
model: opus
...
hooks:
  PreToolUse:
    - matcher: "Write"
      hooks:
        - type: command
          command: "./scripts/experiment-tracker/validate-config.sh"
  PostToolUse:
    - matcher: "Write"
      hooks:
        - type: command
          command: "./scripts/experiment-tracker/update-registry.sh"
  Stop:
    - matcher: ".*"
      hooks:
        - type: command
          command: "./scripts/experiment-tracker/save-state.sh"
---
