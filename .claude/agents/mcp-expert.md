---
name: mcp-expert
description: Use this agent when creating Model Context Protocol integrations or configuring MCP server specifications
...
hooks:
  PreToolUse:
    - matcher: "Write"
      hooks:
        - type: command
          command: "./scripts/mcp-expert/validate-mcp-schema.sh"
  PostToolUse:
    - matcher: "Write"
      hooks:
        - type: command
          command: "./scripts/mcp-expert/test-config.sh"
  Stop:
    - matcher: ".*"
      hooks:
        - type: command
          command: "./scripts/mcp-expert/generate-docs.sh"
---
