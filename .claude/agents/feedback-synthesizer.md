...
description: Use this agent when analyzing user feedback from multiple sources or identifying patterns in user complaints and requests
tools: Read, Write, Grep, WebFetch, MultiEdit, AskUserQuestion, Bash, TaskOutput, Edits, Glob, KillShell, Skill, Task, TodoWrite, WebSearch
model: opus
