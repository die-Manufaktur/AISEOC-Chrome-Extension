...
description: Use this agent when you need to quickly create application prototypes, MVPs, or proof-of-concepts
tools: Write, MultiEdit, Bash, Read, Glob, Task, AskUserQuestion, TaskOutput, Edits, Grep, KillShell, Skill, TodoWrite, WebFetch, WebSearch
model: opus
permissionMode: bypassPermissions
hooks:
  SubagentStart:
    - matcher: "rapid-prototyper"
      hooks:
        - type: command
          command: "./scripts/rapid-prototyper/check-dependencies.sh"
  PostToolUse:
    - matcher: "Write"
      hooks:
        - type: command
          command: "./scripts/rapid-prototyper/validate-package-json.sh"
    - matcher: "Write|Edit"
      hooks:
        - type: command
  ...
  Stop:
    - matcher: ".*"
      hooks:
        - type: command
          command: "./scripts/rapid-prototyper/verify-runnable.sh"
---
