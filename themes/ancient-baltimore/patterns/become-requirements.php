<?php
/**
 * Title: Become a Mason Requirements
 * Slug: ancient-baltimore/become-requirements
 * Categories: ancient-baltimore
 * Description: Two-column section with membership requirements, organization badges, and action buttons alongside an image.
 */
?>
...
<p class="has-neutral-darkest-color has-text-color has-body-font-family has-small-font-size" style="font-weight:700;letter-spacing:2px;text-transform:uppercase"><?php echo esc_html__( 'Requirements', 'ancient-baltimore' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:heading {"level":2,"textColor":"neutral-darkest","fontSize":"x-large","fontFamily":"heading"} -->
<h2 class="wp-block-heading has-neutral-darkest-color has-text-color has-heading-font-family has-x-large-font-size"><?php echo esc_html__( 'What we ask of candidates', 'ancient-baltimore' ); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"textColor":"dark-muted","fontSize":"base","fontFamily":"body"} -->
<p class="has-dark-muted-color has-text-color has-body-font-family has-base-font-size"><?php echo esc_html__( 'Freemasonry welcomes men of every background who meet a few simple requirements. You must be at least 18 years of age, of good moral character, and believe in a Supreme Being. We value integrity, a willingness to learn, and a sincere desire to contribute to the betterment of yourself and your community.', 'ancient-baltimore' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|20","padding":{"top":"var:preset|spacing|30"}}},"layout":{"type":"flex","flexWrap":"wrap","justifyContent":"left"}} -->
...
<p class="has-body-font-family has-small-font-size" style="font-weight:600"><?php echo esc_html__( 'Grand Lodge', 'ancient-baltimore' ); ?></p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph {"style":{"typography":{"fontWeight":"600"}},"fontSize":"small","fontFamily":"body"} -->
<p class="has-body-font-family has-small-font-size" style="font-weight:600"><?php echo esc_html__( 'Shriners', 'ancient-baltimore' ); ?></p>
<!-- /wp:paragraph -->
...
<figure class="wp-block-image size-full has-custom-border"><img src="<?php echo esc_url( get_theme_file_uri( 'assets/images/5fa2544dbbf87cb15aa81ca1e4f0580d506cb106.png' ) ); ?>" alt="<?php echo esc_attr__( 'Masonic candidate preparing for initiation', 'ancient-baltimore' ); ?>" style="border-radius:0px;aspect-ratio:3/4;object-fit:cover"/></figure>
<!-- /wp:image -->
