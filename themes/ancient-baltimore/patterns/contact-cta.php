...
/**
 * Title: Contact CTA
 * Slug: ancient-baltimore/contact-cta
 * Categories: ancient-baltimore
 * Description: Call to action section with heading, subtitle, two buttons, and a full-width image below.
 */
?>
...
<h2 class="wp-block-heading has-text-align-center has-neutral-darkest-color has-text-color has-heading-font-family has-x-large-font-size"><?php echo esc_html__( 'Ready to explore Freemasonry?', 'ancient-baltimore' ); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","textColor":"dark-muted","fontSize":"base","fontFamily":"body"} -->
<p class="has-text-align-center has-dark-muted-color has-text-color has-body-font-family has-base-font-size"><?php echo esc_html__( 'Whether you are interested in membership, have questions about our lodge, or simply want to learn more about the craft, we are here to help. Take the first step today.', 'ancient-baltimore' ); ?></p>
<!-- /wp:paragraph -->
