...
/**
 * Title: Find Us
 * Slug: ancient-baltimore/about-find-us
 * Categories: about, contact
 * Description: Contact information section with address, parking, and meeting schedule details alongside a location image.
 */
?>
...
<h2 class="wp-block-heading has-neutral-darkest-color has-text-color has-heading-font-family has-x-large-font-size"><?php echo esc_html__( 'Find us', 'ancient-baltimore' ); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"textColor":"dark-muted","fontSize":"base","fontFamily":"body"} -->
<p class="has-dark-muted-color has-text-color has-body-font-family has-base-font-size"><?php echo esc_html__( 'Visit our historic lodge building in the heart of Baltimore. We welcome visitors and prospective members.', 'ancient-baltimore' ); ?></p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph {"style":{"typography":{"fontWeight":"700"}},"textColor":"neutral-darkest","fontSize":"base","fontFamily":"body"} -->
<p class="has-neutral-darkest-color has-text-color has-body-font-family has-base-font-size" style="font-weight:700"><?php echo esc_html__( 'Baltimore, Maryland', 'ancient-baltimore' ); ?></p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph {"style":{"typography":{"fontWeight":"700"}},"textColor":"neutral-darkest","fontSize":"base","fontFamily":"body"} -->
<p class="has-neutral-darkest-color has-text-color has-body-font-family has-base-font-size" style="font-weight:700"><?php echo esc_html__( 'Parking available', 'ancient-baltimore' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"textColor":"dark-muted","fontSize":"small","fontFamily":"body"} -->
<p class="has-dark-muted-color has-text-color has-body-font-family has-small-font-size"><?php echo esc_html__( 'Street parking and nearby garages within walking distance of the lodge.', 'ancient-baltimore' ); ?></p>
<!-- /wp:paragraph -->
...
<!-- wp:paragraph {"style":{"typography":{"fontWeight":"700"}},"textColor":"neutral-darkest","fontSize":"base","fontFamily":"body"} -->
<p class="has-neutral-darkest-color has-text-color has-body-font-family has-base-font-size" style="font-weight:700"><?php echo esc_html__( 'Meeting schedule', 'ancient-baltimore' ); ?></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"textColor":"dark-muted","fontSize":"small","fontFamily":"body"} -->
<p class="has-dark-muted-color has-text-color has-body-font-family has-small-font-size"><?php echo esc_html__( 'Stated communications held on the first and third Tuesdays of each month at 7:30 PM.', 'ancient-baltimore' ); ?></p>
<!-- /wp:paragraph -->
...
<figure class="wp-block-image size-full has-custom-border"><img src="<?php echo esc_url( get_theme_file_uri( 'assets/images/5a994c89a6675dbd456d51cc408cc4f10d947df5.png' ) ); ?>" alt="<?php echo esc_attr__( 'Ancient Baltimore Lodge building', 'ancient-baltimore' ); ?>" style="border-radius:0px;aspect-ratio:3/4;object-fit:cover"/></figure>
<!-- /wp:image -->
