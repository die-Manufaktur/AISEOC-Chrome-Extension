...
<!-- wp:image {"sizeSlug":"full","linkDestination":"none","style":{"border":{"radius":"0px"}},"aspectRatio":"3/2"} -->
<figure class="wp-block-image size-full has-custom-border"><img src="<?php echo esc_url( get_theme_file_uri( 'assets/images/226f66acc1b7dec24e9fa16a00c9906d6f090bed.png' ) ); ?>" alt="<?php echo esc_attr__( 'Annual scholarship dinner event', 'ancient-baltimore' ); ?>" style="border-radius:0px;aspect-ratio:3/2;object-fit:cover"/></figure>
<!-- /wp:image -->
...
<!-- wp:image {"sizeSlug":"full","linkDestination":"none","style":{"border":{"radius":"0px"}},"aspectRatio":"3/2"} -->
<figure class="wp-block-image size-full has-custom-border"><img src="<?php echo esc_url( get_theme_file_uri( 'assets/images/29ff4deba4ee7e22e18cc1d9a89e9be96cfbd51a.png' ) ); ?>" alt="<?php echo esc_attr__( 'Community outreach day event', 'ancient-baltimore' ); ?>" style="border-radius:0px;aspect-ratio:3/2;object-fit:cover"/></figure>
<!-- /wp:image -->
