<?php
/**
 * Title: Foundation CTA
 * Slug: ancient-baltimore/foundation-cta
 * Categories: ancient-baltimore, call-to-action
 * Description: Call to action section for the foundation with heading, subtitle, two buttons, and a full-width image below.
 */
?>
...
<h2 class="wp-block-heading has-text-align-center has-neutral-darkest-color has-text-color has-heading-font-family has-x-large-font-size"><?php echo esc_html__( 'Support our mission', 'ancient-baltimore' ); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","textColor":"dark-muted","fontSize":"base","fontFamily":"body"} -->
<p class="has-text-align-center has-dark-muted-color has-text-color has-body-font-family has-base-font-size"><?php echo esc_html__( 'Your generosity enables us to continue our charitable work, fund scholarships, and strengthen the Baltimore community. Every contribution, no matter the size, makes a meaningful difference.', 'ancient-baltimore' ); ?></p>
<!-- /wp:paragraph -->
...
<figure class="wp-block-image alignwide size-full has-custom-border"><img src="<?php echo esc_url( get_theme_file_uri( 'assets/images/5a994c89a6675dbd456d51cc408cc4f10d947df5.png' ) ); ?>" alt="<?php echo esc_attr__( 'Ancient Baltimore Lodge building and community gathering', 'ancient-baltimore' ); ?>" style="border-radius:0px"/></figure>
<!-- /wp:image -->
