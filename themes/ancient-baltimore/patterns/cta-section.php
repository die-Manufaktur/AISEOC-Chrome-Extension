...
<figure class="wp-block-image alignwide size-full has-custom-border"><img src="<?php echo esc_url( get_theme_file_uri( 'assets/images/5a994c89a6675dbd456d51cc408cc4f10d947df5.png' ) ); ?>" alt="<?php echo esc_attr__( 'Ancient Baltimore Lodge building exterior', 'ancient-baltimore' ); ?>" style="border-radius:0px"/></figure>
<!-- /wp:image -->
